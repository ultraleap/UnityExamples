# A Cuboid Sensation that uses ProjectPathOntoPlane to create 
# an extruded polyline that acts like an infinitely long cuboid columm
from pysensationcore import *
import sensation_helpers as sh

block = defineBlock("Cuboid")
defineInputs(block,
             "objectCentre",
             "point0",
             "point1",
