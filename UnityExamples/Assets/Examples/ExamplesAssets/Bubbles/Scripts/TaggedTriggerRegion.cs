...
{
    // This is similar to the basic Haptic Trigger region, but includes
    // a list option to ignore objects with a certain Tag.
    // In this example, the 'Bubble' tag is ignored, to avoid haptics triggering
    // When a bubble collides with another collider.
    public class TaggedTriggerRegion : MonoBehaviour
    {
        public class EditorHelpBoxAttribute : PropertyAttribute { }

        //[EditorHelpBox, SerializeField] private bool dummyField_;
        public List<string> TagsToIgnore = new List<string> { "Bubble" };
        ...
        protected virtual void OnTriggerEnter(Collider other)
        {
            ...
            // Return if the tag of the Collider which entered is in the ignoreList
            if (TagsToIgnore.Contains(colliderTag)){
                return;
            }
