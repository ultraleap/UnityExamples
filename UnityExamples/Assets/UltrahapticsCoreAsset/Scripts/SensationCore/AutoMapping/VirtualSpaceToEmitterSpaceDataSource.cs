...
public class VirtualSpaceToEmitterSpaceDataSource : MonoBehaviour, IDataSource
{
    ...
    void Start()
    {
        data_.Add("virtualOriginInEmitterSpace", new UnityEngine.Vector3(0, 0, 0));
        data_.Add("virtualXInEmitterSpace", new UnityEngine.Vector3(1, 0, 0));
        data_.Add("virtualYInEmitterSpace", new UnityEngine.Vector3(0, 0, 1));
        data_.Add("virtualZInEmitterSpace", new UnityEngine.Vector3(0, 1, 0));
